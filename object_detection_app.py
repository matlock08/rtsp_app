...
if __name__ == '__main__':
    ...
    parser.add_argument('-src', '--source', dest='video_source', type=str,
                        default='rtsp://eyezon:M@n39ha77an@10.1.1.206:554/videoMain', help='Device url of the camera.')
    ...
    #  video_capture = cv2.VideoCapture("rtsp://eyezon:M@n07ha77an@10.1.1.3:554/videoMain")
    #  video_capture = cv2.VideoCapture("rtsp://admin:roniit@resproni.dyndns.org:554/stream0/mobotix.mjpeg")
